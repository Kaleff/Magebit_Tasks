            ...
            if($this->data['totalPages']>1) {
                for ($pageCounter = 1; $pageCounter <= $this->data['totalPages']; $pageCounter++) {
                    if($this->data['page'] = $pageCounter) {
                        echo "<a href='/database/?page={$pageCounter}'><button class='grayButton'>Page $pageCounter</button></a>";
                    } else {
                        echo "<a href='/database/?page={$pageCounter}'><button class='whiteButton'>Page $pageCounter</button></a>";
                    }
                }
            }
        ?>
